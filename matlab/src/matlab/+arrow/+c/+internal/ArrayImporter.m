...
classdef ArrayImporter
    ...
    methods
        ...
        function arrowArray = import(obj, arrowArrayAddress, arrowSchemaAddress)
            arguments
                obj(1, 1) arrow.c.internal.ArrayImporter
                arrowArrayAddress(1, 1) uint64
                arrowSchemaAddress(1, 1) uint64
            end
            args = struct(ArrowArrayAddress=arrowArrayAddress, ...
                ArrowSchemaAddress=arrowSchemaAddress);
