...
classdef tDate64Array < matlab.unittest.TestCase & ...
    ...
    properties
        ...
        correspondingMATLABArrayForIndexingTests = [...
                                                    datetime(1970,1,1), ...
                                                    NaT, ...
                                                    datetime(1970,1,1,0,0,0.001), ...
                                                    datetime(1987,12,31), ... % leap second added
                                                    NaT, ...
                                                    NaT, ...
                                                    datetime(2015,6,30), ...  % leap second added
                                                    datetime(2016,12,31,0,0,0.999), ...
                                                    datetime(2020,2,29,12,0,0), ...
                                                    datetime(2023,11,16,23,59,59.555), ...
                                                   ];
        arrowArrayForIndexingTests = arrow.array.Date64Array.fromMATLAB(...
                                                   [...
                                                    datetime(1970,1,1), ...
                                                    NaT, ...
                                                    datetime(1970,1,1,0,0,0.001), ...
