...
classdef hTabular < matlab.unittest.TestCase
    ...
    properties (TestParameter)
        ...
        IndexingError = struct(...
            ...
            AmbiguousFieldName=struct(...
                Value={"A", "B", "C"}, ...
                Error="arrow:tabular:schema:AmbiguousFieldName" ...
            ), ...
            NonexistentFieldName=struct(...
                Value={"a", "aA", "D", "", " "}, ...
                Error="arrow:tabular:schema:AmbiguousFieldName" ...
            ), ...
            NonScalarFieldName=struct(...
    ...
    methods (TestClassSetup)
        ...
        function initializeProperties(testCase)
            ...
            testCase.ArrowTabularTypeIndexingError = testCase.TabularFromArraysFunction(...
                arrow.array([1, 2, 3]), ...
                arrow.array([1, 2, 3]), ...
                arrow.array(["A", "B", "C"]), ...
                arrow.array(["A", "B", "C"]), ...
    ...
    methods (Test)
        ...
        function ColumnIndexingError(testCase, IndexingError)
            % Verify that appropriate errors are thrown when invalid
            % index values are provided to the column(index) method.
            for ii = 1:numel(IndexingError)
                indexingError = IndexingError(ii);
                index = indexingError.Value;
                fcn = @() testCase.ArrowTabularTypeIndexingError.column(index);
                testCase.verifyError(fcn, indexingError.Error);
            end
        end
